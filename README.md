...
```bash
git clone https://github.com/your-org/legal-10.git
cd legal-10
...
This project uses data from the Legal Hallunicatio on the [Dahl et al. Legal Hallucinations Dataset](https://huggingface.co/datasets/reglab/legal_hallucinations_paper_data):
...
Questions? Open an issue or contact [jondev717@gmail.com].
